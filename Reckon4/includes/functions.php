...
function drawHeader1($s=0){

	
			ECHO "
			<header class='header' style = 'background-color: #FBF2F4'>
			<div class='container'>
				<a href='index.php' ><img class='logo' style='height:70px;' href='index.php' src='assets/img/549-5497327_pink-roses-clipart-removebg-preview.png'></a>   <div class='brand'> Blossoming Sustainability </div>";
...
function echoaddadsnolog(){
	echo "</header>
	<div class='container control'>
	<a   class='btn btn-lg btn-block addads ' href='createads.php' data-toggle='modal' data-target='#myModal'>+ Place an Ad</a>
	</div>
	";
}
